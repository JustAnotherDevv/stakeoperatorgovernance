...
function App() {
  return (
    <div className="bg-zinc-900 pb-48">
      ...
      <footer className="footer items-center p-3 bg-neutral/90 backdrop-blur-md shadow-md text-neutral-content absolute bottom-0">
        <div className="items-center grid-flow-col ml-4">
          ...
          <p>Created during HackOnChain | 2022</p>
        </div>
